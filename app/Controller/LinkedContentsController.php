...
class LinkedContentsController extends AppController {
	public $uses = array('Content','Tag','RelatedCompanies', 'LinkedContent');
...
// 				$contents = $this->LinkedContent->find('all', array(
// 					'recursive' => 0
// 				));
// 				debug($contents); die;
	            ...
	            foreach($contents as $content) {
	            	if(!in_array($content['Content']['id'],$links)) {
		            	$parsedContents[] = array('id' => $content['Content']['id'],
